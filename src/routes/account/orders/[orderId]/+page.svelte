...
<section>
	...
	<Table.Root>
		<Table.Caption>Contents of order</Table.Caption>
		<Table.Header>
			<Table.Row>
				...
				<Table.Row>
					...
					<Table.Cell>
						<img
							src={product.img[0]}
							alt="product"
							class="w-[100px] rounded object-cover object-center"
						/>
					</Table.Cell>
	...
	{#if !order.is_payed}
		<Button class="my-3 w-full rounded" href={`/account/orders/${order.id}/pay`}>Pay</Button>
	{/if}
</section>
