...
{#if form?.success}
	<h2 class="mb-3 text-center text-2xl">Success in making account</h2>
	<Button class="w-full rounded" href="/account/subscription">View Subscriptions</Button>
{:else}
	<h2 class="text-center text-2xl">Create Account</h2>
